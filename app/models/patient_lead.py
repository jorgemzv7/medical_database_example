import uuid
from sqlalchemy import Column, ForeignKey, DateTime, Boolean, Index, func
...
class PatientLead(Base):
    ...
    valid_from = Column(DateTime, nullable=False, default=func.now()) # Initial consult record now
    valid_to = Column(DateTime, nullable=True, default=True)
    is_current = Column(Boolean, default=True, default=True)  # current record
